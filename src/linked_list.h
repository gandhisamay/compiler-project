...
typedef enum {S, Program, ModuleDeclarations, ModuleDeclaration, OtherModules, DriverModule, Module, Ret, Input_plist, N1, Output_plist, N2, DataType, Range_arrays, Type, ModuleDef, Statements, Statement, IoStmt, BoolConstt, Id_num_rnum, Var_id_num, Array_element_for_print, Var_print, P1, SimpleStmt, AssignmentStmt, WhichStmt, LvalueIDStmt, LvalueARRStmt, Index_arr, New_index, Sign, ModuleReuseStmt, Actual_para_list, Optional, IdList, N3, Expression, U, New_NT, Unary_op, ArithmeticOrBooleanExpr, N7, AnyTerm, N8, ArithmeticExpr, N4, Term, N5, Factor, N11, Element_index_with_expressions, N10, ArrExpr, Arr_N4, ArrTerm, Arr_N5, ArrFactor, Op1, Op2, LogicalOp, RelationalOp, DeclareStmt, ConditionalStmt, CaseStmts, N9, Value, Default, IterativeStmt, Range, Range_for_loop, Index_for_loop, New_index_for_loop, Sign_for_loop, Actual_para_list1, Actual_para_iD, N_TERMINAL_SYM} n_terminals;

char *n_term_str[] = {"S", "Program", "ModuleDeclarations", "ModuleDeclaration", "OtherModules", "DriverModule", "Module", "Ret", "Input_plist", "N1", "Output_plist", "N2", "DataType", "Range_arrays", "Type", "ModuleDef", "Statements", "Statement", "IoStmt", "BoolConstt", "Id_num_rnum", "Var_id_num", "Array_element_for_print", "Var_print", "P1", "SimpleStmt", "AssignmentStmt", "WhichStmt", "LvalueIDStmt", "LvalueARRStmt", "Index_arr", "New_index", "Sign", "ModuleReuseStmt", "Actual_para_list", "Optional", "IdList", "N3", "Expression", "U", "New_NT", "Unary_op", "ArithmeticOrBooleanExpr", "N7", "AnyTerm", "N8", "ArithmeticExpr", "N4", "Term", "N5", "Factor", "N11", "Element_index_with_expressions", "N10", "ArrExpr", "Arr_N4", "ArrTerm", "Arr_N5", "ArrFactor", "Op1", "Op2", "LogicalOp", "RelationalOp", "DeclareStmt", "ConditionalStmt", "CaseStmts", "N9", "Value", "Default", "IterativeStmt", "Range", "Range_for_loop", "Index_for_loop", "New_index_for_loop", "Sign_for_loop", "Actual_para_list1", "Actual_para_iD", "N_TERMINAL_SYM"};
