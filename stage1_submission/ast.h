...
AST_NODE* insert_at_head_syn(AST_NODE* list_head, AST_NODE* node);
AST_NODE* insert_at_head_inh(AST_NODE* list_head, AST_NODE* node);
AST_NODE* insert_at_end_syn(AST_NODE* list_tail, AST_NODE* node);
AST_NODE* insert_at_end_inh(AST_NODE* list_tail, AST_NODE* node);
